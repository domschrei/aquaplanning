...
public class Ipasir4j {
	...
	/**
	 * Constructor with specifying the name of the shared library implementing the
	 * native SAT solver functions, default is "ipasir4j".
	 */
	...
	/**
	 * Add a literal to the next clause to be added. Call with 0 to finalize the
	 * current clause.
	 */
	...
	/**
	 * Add a clause (not necessarily zero terminated) to the SAT solver.
	 */
	...
	/**
	 * Add an assumption that will be used for the next 'solve' call.
	 */
	...
	/**
	 * Add a set of assumption that will be used for the next 'solve' call.
	 */
	...
	/**
	 * Solve the SAT problem specified by previous 'add's (since init) and 'assume's
	 * (since last 'solve').
	 */
	...
	/**
	 * If solve finished with SATISFIABLE this method return the truth value of the
	 * specified variable. returns var for True, -var for False, 0 for irrelevant.
	 */
	...
	/**
	 * Returns true if the given literal was among the assumptions that were used to
