...
/**
 * Produces and maintains information on atoms, numeric atoms and derived atoms.
 */
public class AtomTable {
	...
	/**
	 * Retrieves a copy of the atom corresponding to the provided predicate and
	 * constant arguments. If this atom has not been grounded before, it will be
	 * created.
	 */
	...
	/**
	 * Retrieves the derived atom corresponding to the provided derived predicate
	 * and constant arguments. If this atom has not been grounded before, it will be
	 * created. Note that the original object is returned and changes to it will be
	 * reflected in the original data structure.
	 */
	public DerivedAtom derivedAtom(Predicate p, List<Argument> constants) {
		...
		if (!derivedAtoms.containsKey(atomName)) {
			...
			AbstractCondition cond = axiom.getCondition().getConditionBoundToArguments(axiom.getArguments(), constants);
	...
	/**
	 * Assembles the name of an atom with a given predicate and a list of constant
	 * arguments.
	 */
	...
	/**
	 * Assembles the name of an action corresponding to the provided operator with
	 * the provided list of constant arguments.
	 */
	...
	/**
	 * Returns the collected map of derived atoms. Keys are the atom names as
	 * retrieved by getDerivedAtomName().
	 */
