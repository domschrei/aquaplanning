...
public class Operator {
	...
	/**
	 * Creates a copy of this operator where its arguments have been assigned the
	 * provided list of constants (in that order).
	 */
	...
	public int hashCode() {
		...
		// result = prime * result + ((precondition == null) ? 0 :
	...
	public boolean equals(Object obj) {
		...
		if (arguments == null) {
			...
			return false;
		/*
		 * if (cost != other.cost) return false; if (effect == null) { if (other.effect
		 * != null) return false; } else if (!effect.equals(other.effect)) return false;
		 */if (name == null) {
			if (other.name != null)
				return false;
			...
			return false;
		/*
		 * if (precondition == null) { if (other.precondition != null) return false; }
