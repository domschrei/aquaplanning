...
/**
 * A set of atoms. Can be used to represent a set of true atoms XOR a set of
 * false atoms (not both at the same time).
 */
public class AtomSet {
	...
	/**
	 * Initialized an atom set from a list of Atom objects. Only sets the atoms in
	 * the list which have the provided value.
	 */
	...
	/**
	 * Get the index of the next true atom at or after index i, or -1 if none such
	 * atom is true
	 */
	...
	/**
	 * True iff the provided atom is contained in this set (or, if the atom has a
	 * value of false, it is *not* contained).
	 */
	...
	/**
	 * True iff all atoms which are set in the provided other AtomSet are also
	 * contained in this AtomSet.
	 */
	...
	/**
	 * True iff none of the atoms which are set in the provided other AtomSet are
	 * contained in this AtomSet.
	 */
	...
	/**
	 * Calculates the logical AND of this AtomSet with another AtomSets and returns
	 * the result.
	 * 
	 * @param other The other AtomSet
	 * @return The logical AND of this and the other AtomSet
	 */
	...
	/**
	 * Calculates the logical XOR of this AtomSet with another AtomSets and returns
	 * the result.
	 * 
	 * @param other The other AtomSet
	 * @return The logical AND of this and the other AtomSet
	...
	/**
	 * In this AtomSet, sets all atoms which are contained in the other provided
	 * AtomSet.
	 */
	...
	/**
	 * In this AtomSet, *unsets* all atoms which are contained in the other provided
	 * AtomSet.
	 */
