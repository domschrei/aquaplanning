...
(:goal
    :tasks  (
                ...
                (tag t2 (do_cocktail_in_shot shot2 cocktail6))
                (tag t3 (do_cocktail_in_shot shot3 cocktail11))
                (tag t4 (do_cocktail_in_shot shot4 cocktail8))
                (tag t5 (do_cocktail_in_shot shot5 cocktail7))
                (tag t6 (do_cocktail_in_shot shot6 cocktail9))
                (tag t7 (do_cocktail_in_shot shot7 cocktail2))
                (tag t8 (do_cocktail_in_shot shot8 cocktail3))
                (tag t9 (do_cocktail_in_shot shot9 cocktail5))
                (tag t10 (do_cocktail_in_shot shot10 cocktail1))
                (tag t11 (do_cocktail_in_shot shot11 cocktail10))
                (tag t12 (do_cocktail_in_shot shot12 cocktail2))
                (tag t13 (do_cocktail_in_shot shot13 ingredient2))
                (tag t14 (do_cocktail_in_shot shot14 ingredient3))
            )
